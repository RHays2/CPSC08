...
class TourTableViewController: UITableViewController {
    //MARK: Properties
    static let CELL_IDENTIFIER = "TourTableViewCell"
    var tours = [Tour]()
    ...
    func loadAllTourInfo() {
        //make sure the DB reference is not nil
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if let destination = segue.destination as? TourDescriptionViewController {
            ...
            destination.selectedTour = toursInfo[(tableView.indexPathForSelectedRow?.row)!]
            destination.databaseReference = self.databaseReference
            //deselct row
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell { 
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: TourTableViewController.CELL_IDENTIFIER, for:indexPath)
        guard let tourCell = cell as? TourTableViewCell else {
            return cell
        }
        
        let tourInfo = toursInfo[indexPath.row]
        tourCell.tourName.text = tourInfo.tourName
        tourCell.tourDescription.text = tourInfo.tourDescription
        if let image = tourInfo.previewImage {
            tourCell.tourImage.image = image
        } else {
            let previewImage = UIImage(named: "default_preview_image")
            tourCell.tourImage.image = previewImage
            tourInfo.previewImage = previewImage
        }
...
////            }
//
//        let cHall1 = Stop(stopName: "College Hall Stop 1", stopDescription: "College Hall Stop 1", stopAssets: [asset1], stopLatitude: 47.668112, stopLongitude: -117.401748, order: 1, id:"1")
//        let cHall2 = Stop(stopName: "College Hall Stop 2", stopDescription: "College Hall Stop 2", stopAssets: [asset1], stopLatitude: 47.668108, stopLongitude: -117.402419, order: 2, id:"2")
//
//        let cHall3 = Stop(stopName: "College Hall Stop 3", stopDescription: "College Hall Stop 3", stopAssets: [asset1], stopLatitude: 47.668101, stopLongitude: -117.403331, order: 3, id:"3")     fatalError("Unable to instantiate cHall3")
//        }
//
//
//        let tour1 = Tour(tourName: "College Hall", tourImage:tourPhoto1, tourDescription: "A tour of the first building of Gonzaga", tourStops: [cHall1, cHall2, cHall3], tourDistance: 0.5, tourTime: 30)
//
//        guard let foley1 = Stop(stopName: "Foley Library Stop 1", stopDescription: "Foley Library Stop 1", stopAssets: [asset1], stopLatitude: 47.666714, stopLongitude: -117.401201, order: 1, id:"1")
//            else {
//                fatalError("Unable to instantiate foley1")
//        }
//        guard let foley2 = Stop(stopName: "Foley Library Stop 2", stopDescription: "Foley Library Stop 2", stopAssets: [asset1], stopLatitude: 47.666439, stopLongitude: -117.400917, order: 2, id:"2")
//            else {
//                fatalError("Unable to instantiate foley2")
//        }
//        guard let foley3 = Stop(stopName: "Foley Library Stop 3", stopDescription: "Foley Library Stop 3", stopAssets: [asset1], stopLatitude: 47.666526, stopLongitude: -117.400322, order: 3, id:"3")
//            else {
...
//        }
//
//        guard let hemmy1 = Stop(stopName: "Hemmingson Stop 1", stopDescription: "Hemmingson Stop 1", stopAssets: [asset1], stopLatitude: 47.667126, stopLongitude: -117.399839, order: 1, id:"1")
//            else {
//                fatalError("Unable to instantiate hemmy1")
//        }
//        guard let hemmy2 = Stop(stopName: "Hemmingson Stop 2", stopDescription: "Hemmingson Stop 2", stopAssets: [asset1], stopLatitude: 47.667090, stopLongitude: -117.399211, order: 2, id:"2")
//            else {
//                fatalError("Unable to instantiate hemmy2")
//        }
//        guard let hemmy3 = Stop(stopName: "COG", stopDescription: "Hemmingson Stop 3", stopAssets: [asset1], stopLatitude: 47.667101, stopLongitude: -117.398380, order: 3, id:"3")
//            else {
...
//
//
//        guard let paccar1 = Stop(stopName: "It's okay to fail", stopDescription: "Paccar Stop 1", stopAssets: paccar1Assets, stopLatitude: 47.666364, stopLongitude: -117.401840, order: 1, id:"1")
//            else {
//                fatalError("Unable to instantiate paccar1")
//        }
//        guard let paccar2 = Stop(stopName: "Dean's Office", stopDescription: "Paccar Stop 2", stopAssets: paccar2Assets, stopLatitude: 47.666328, stopLongitude: -117.402130, order: 2, id:"2")
//            else {
//                fatalError("Unable to instantiate paccar2")
//        }
//        guard let paccar3 = Stop(stopName: "Sky Bridge", stopDescription: "Paccar Stop 3", stopAssets: paccar3Assets, stopLatitude: 47.666491, stopLongitude: -117.402446, order: 3, id:"3")
//            else {
...
//        }
//
//        guard let luger1 = Stop(stopName: "Luger Stop 1", stopDescription: "Luger Stop 1", stopAssets: [asset1], stopLatitude: 47.665949, stopLongitude:  -117.402119, order: 1, id:"1")
//            else {
//                fatalError("Unable to instantiate luger1")
//        }
//        guard let luger2 = Stop(stopName: "Luger Stop 2", stopDescription: "Luger Stop 2", stopAssets: [asset1], stopLatitude: 47.665310, stopLongitude: -117.402103, order: 2, id:"2")
//            else {
//                fatalError("Unable to instantiate luger2")
//        }
//        guard let luger3 = Stop(stopName: "Luger Stop 3", stopDescription: "Luger Stop 3", stopAssets: [asset1], stopLatitude: 47.664508, stopLongitude: -117.402039, order: 3, id:"3")
//            else {
...
//
//
//        guard let parking1 = Stop(stopName: "Parking Stop 3", stopDescription: "Parking Stop 1", stopAssets: [asset1], stopLatitude: 47.664364, stopLongitude: -117.398905, order: 1, id:"1")
//            else {
//                fatalError("Unable to instantiate parking1")
//        }
//        guard let parking2 = Stop(stopName: "Parking Stop 3", stopDescription: "Parking Stop 2", stopAssets: [asset1], stopLatitude: 47.668009, stopLongitude: -117.397076, order: 2, id:"2")
//            else {
//                fatalError("Unable to instantiate parking2")
//        }
//        guard let parking3 = Stop(stopName: "Parking Stop 3", stopDescription: "Parking Stop 3", stopAssets: [asset1], stopLatitude: 47.668770, stopLongitude: -117.402216, order: 3, id:"3")
//            else {
...
//
//
//        guard let rosauer1 = Stop(stopName: "Rosauer Stop 3", stopDescription: "Rosauer Stop 1", stopAssets: [asset1], stopLatitude: 47.668123, stopLongitude: -117.399453, order: 1, id:"1")
//            else {
//                fatalError("Unable to instantiate rosauer1")
//        }
//        guard let rosauer2 = Stop(stopName: "Rosauer Stop 3", stopDescription: "Rosauer Stop 2", stopAssets: [asset1], stopLatitude: 47.668137, stopLongitude: -117.399147, order: 2, id:"2")
//            else {
//                fatalError("Unable to instantiate rosauer2")
//        }
//        guard let rosauer3 = Stop(stopName: "Rosauer Stop 3", stopDescription: "Rosauer Stop 3", stopAssets: [asset1], stopLatitude: 47.668076, stopLongitude: -117.398809, order: 3, id:"3")
//            else {
...
//
//
//        guard let desmet1 = Stop(stopName: "Desmet Stop 1", stopDescription: "Desmet Stop 1", stopAssets: [asset1], stopLatitude: 47.667945, stopLongitude: -117.401122, order: 1, id:"1")
//            else {
//                fatalError("Unable to instantiate desmet1")
//        }
//        guard let desmet2 = Stop(stopName: "Desmet Stop 2", stopDescription: "Desmet Stop 2", stopAssets: [asset1], stopLatitude: 47.667849, stopLongitude: -117.401126, order: 2, id:"2")
//            else {
//                fatalError("Unable to instantiate desmet2")
//        }
//        guard let desmet3 = Stop(stopName: "Desmet Stop 3", stopDescription: "Desmet Stop 3", stopAssets: [asset1], stopLatitude: 47.667679, stopLongitude: -117.401078, order: 3, id:"3")
//            else {
...
//        }
//
//        guard let coughlin1 = Stop(stopName: "Coughlin Stop 1", stopDescription: "Coughlin Stop 1", stopAssets: [asset1], stopLatitude: 47.664924, stopLongitude: -117.396824, order: 1, id:"1")
//            else {
//                fatalError("Unable to instantiate coughlin1")
//        }
//        guard let coughlin2 = Stop(stopName: "Coughlin Stop 2", stopDescription: "Coughlin Stop 2", stopAssets: [asset1], stopLatitude: 47.664577, stopLongitude: -117.396878, order: 2, id:"2")
//            else {
//                fatalError("Unable to instantiate coughlin2")
//        }
//        guard let coughlin3 = Stop(stopName: "Coughlin Stop 3", stopDescription: "Coughlin Stop 3", stopAssets: [asset1], stopLatitude: 47.665220, stopLongitude: -117.396867, order: 3, id:"3")
//            else {
...
//        }
//
//        guard let jundt1 = Stop(stopName: "Jundt Stop 1", stopDescription: "Jundt Stop 1", stopAssets: [asset1], stopLatitude: 47.666333, stopLongitude: -117.407145, order: 1, id:"1")
//            else {
//                fatalError("Unable to instantiate jundt1")
//        }
//        guard let jundt2 = Stop(stopName: "Jundt Stop 2", stopDescription: "Jundt Stop 2", stopAssets: [asset1], stopLatitude: 47.666331, stopLongitude: -117.406870, order: 2, id:"2")
//            else {
//                fatalError("Unable to instantiate jundt2")
//        }
//        guard let jundt3 = Stop(stopName: "Jundt Stop 3", stopDescription: "Jundt Stop 3", stopAssets: [asset1], stopLatitude: 47.666400, stopLongitude: -117.406532, order: 3, id:"3")
//            else {
...
//        }
//
//        guard let jepson1 = Stop(stopName: "Jepson Stop 1", stopDescription: "Jepson Stop 1", stopAssets: [asset1], stopLatitude: 47.666989, stopLongitude: -117.405009, order: 1, id:"1")
//            else {
//                fatalError("Unable to instantiate jepson1")
//        }
//        guard let jepson2 = Stop(stopName: "Jepson Stop 2", stopDescription: "Jepson Stop 2", stopAssets: [asset1], stopLatitude: 47.667256, stopLongitude: -117.405194, order: 2, id:"2")
//            else {
//                fatalError("Unable to instantiate jepson2")
//        }
//        guard let jepson3 = Stop(stopName: "Jepson Stop 3", stopDescription: "Jepson Stop 3", stopAssets: [asset1], stopLatitude: 47.667133, stopLongitude: -117.405641, order: 3, id:"3")
//            else {
